        ...
        return (
            <div className="flex w-2/3 mx-auto mt-20">
                ...
                <div>
                    ...
                    <button onClick={()=>this.handleMasuk()} className="flex items-center justify-center border-2 border-gray-900 w-full rounded-md text-lg font-semibold py-2 focus:outline-none">
